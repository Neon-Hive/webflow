...
tl.to(".transition_wrap", {yPercent: -100, delay: 0.6, duration: 1, easing: "inOutCubic"})
...
tl.set(".transition_wrap", {display: "flex"})
  tl.fromTo(".transition_wrap", {yPercent: 100}, {yPercent: 0, delay: 0.2, duration: 1, easing: "inOutCubic"})
}
});
// On Back Button Tap
