...
// Use ScrollTrigger's matchMedia to create responsive animations
ScrollTrigger.matchMedia({
  // Desktop/large screens (min-width: 992px)
  "(min-width: 992px)": function() {
    // Animate the main container with scrub for larger screens
    ...
    // Store the trigger for later cleanup
